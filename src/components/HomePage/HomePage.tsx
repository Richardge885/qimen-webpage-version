...
const HomePage = () => {
    ...
    const numberInputStyle = "w-[17.5vw] h-[4vh] text-[1.5rem] bg-bgdark rounded-[0.48rem] text-center";
    ...
    return (
        <div className="flex flex-col bg-bglight h-screen justify-center items-center">
            <div className="flex flex-col justify-center items-center h-[60vh] gap-[15vh]">
                <h1 className="font-lishu text-red text-[10rem]">鸣法</h1>
                <div className="flex flex-col flex-nowrap justify-center items-center">
                    <div>
                        <label className={inputLabel} htmlFor="year">
                            年
                            <input type="number" name="year" id="" className={numberInputStyle} min={1} max={9999} value={currentTimeValuesInNumbers.year} />
                        </label>
                        <label className={inputLabel} htmlFor="month">
                            月
                            <input type="number" name="month" id="" className={numberInputStyle} min={1} max={12} value={currentTimeValuesInNumbers.month} />
                        </label>
                        <label className={inputLabel}>
                            日
                            <input type="number" name="day" id="" className={numberInputStyle} min={1} max={31} value={currentTimeValuesInNumbers.day} />
                        </label>
                    </div>
                    <div>
                        <label className={inputLabel}>
                            时
                            <input type="number" name="hour" id="" className={numberInputStyle} min={0} max={24} value={currentTimeValuesInNumbers.hour} />
                        </label>
                        <label className={inputLabel}>
                            分
                            <input type="number" name="minute" id="" className={numberInputStyle} min={0} max={60} value={currentTimeValuesInNumbers.minutes} />
                        </label>
                    </div>
                </div>
            </div>
